...
# basis 0
# qq 0
#my commands are follows:
#[help] this dialog
#[chname] change your name
# qq 1
#something is wrong I'm broken
#new command [fix]
# qq 2
## NPC
#npc_activate 2
...
#npc_activate 2
#activated true
#find my maintenence robot and ask him what do I need to be fixed
# qq 1
#fix me
# qq 2
## NPC
...
#[chname] change your name
# qq 1
#lets change your name
#there's new bot available for you
#at south east
## NPC
#npc_activate 3
#activated true
# qq 2
#I was just rebooted no need to reboot again!!!

# maintenence bot
# basis 0
# qq 0
#sorry but I need to know what kind of help you need
# qq 1
#what seems to be wrong?
# basis 1
# qq 0
#if change name doesn't work
#try resetting him.
#with
#[reboot] command
...
# basis 0
# qq 0
#oh interesting and you figured out while others couldn't
# qq 1
#rebooting, ...
# basis 1
# qq 0
#yes well there are forks in quest line-s
#some lead to dead end.
#you might found one when you got to here if you rebooted me.
#you needed to go way longer it was a fork witch didn't lead to dead end.
#in future there will be
# qq 1
#well chosse wisely
#
#building a factory through gathering
#building a factory through crafting
#building a factory through fighting
#
#we will be sending bots as needed
# qq 2
