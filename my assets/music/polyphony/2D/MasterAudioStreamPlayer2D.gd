class_name MasterAudioStreamPlayer2D extends Node2D

@export var sample_audio_player_to_duplicate: AudioStreamPlayer2D

var array_polyphony_3d: Array[AudioStreamPlayer2D]
